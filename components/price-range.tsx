...
export function PriceRangeSelect({ ranges }: PriceRangeSelectProps) {
  ...
  const query = `The selected price range is ${selected}, now call the show_bedroom_selection function to display the bedroom selection ui.`;
